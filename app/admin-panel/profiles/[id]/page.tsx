...
export default async function AdminProfileDetailPage({
  ...
  const isAdminAccount = profile.username === 'admin'
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                {profile.is_admin && !isAdminAccount && (
            ...
            {followers.map((follow: any) => {
              ...
              return (
                <Link
                  ...
                  href={`/admin-panel/profiles/${follow.follower_id}`}
            ...
            {following.map((follow: any) => {
              ...
              return (
                <Link
                  ...
                  href={`/admin-panel/profiles/${follow.following_id}`}
                  className="flex items-center gap-3 p-2 border border-black hover:bg-gray-100 transition"
                >
